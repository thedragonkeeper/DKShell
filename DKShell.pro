...
UBUNTU_TRANSLATION_DOMAIN="dkshell.dragonkeeper"
...
aptest.commands = QML2_IMPORT_PATH=$$OUT_PWD/backend bash $$PWD/DKShell/tests/autopilot/run
aptest.depends  = sub-DKShell sub-backend-App

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/backend/tests/unit -import $$OUT_PWD/backend
unittest.commands += && /usr/bin/qmltestrunner -input $$PWD/DKShell/tests/unit -import $$OUT_PWD/backend
unittest.depends  = sub-DKShell sub-backend-App
